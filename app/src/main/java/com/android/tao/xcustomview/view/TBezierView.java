...
/**
 * Created by administrato on 2017/4/1.
 */

public class TBezierView extends View {

    private static final String TAG = TBezierView.class.getSimpleName();
    ...
    public TBezierView(Context context) {
        this(context,null);
    }

    public TBezierView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TBezierView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        super.onDraw(canvas);
        ...
        rectPath.moveTo(-r, rArc);
        rectPath.lineTo(-r, r);
        rectPath.lineTo(r, r);
        rectPath.lineTo(r, rArc);
